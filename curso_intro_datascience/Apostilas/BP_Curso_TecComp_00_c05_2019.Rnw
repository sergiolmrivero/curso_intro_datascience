...
lm.hpmpg.tab <- xtable(hpmpg, caption = 'Resultado do Modelo Consumo versus HP', label  = 'tabreg:consumohp')

print.xtable(lm.hpmpg.tab, caption.placement = 'top')
@


Agora, podemos incluir outros detalhes na tabela, como títulos, por exemplo.
