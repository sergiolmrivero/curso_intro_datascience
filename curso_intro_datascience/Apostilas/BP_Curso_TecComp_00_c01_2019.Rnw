...
A figura \ref{fig:f01-05} apresenta a página inicial do site do \textbf{Rstudio}. Para ter acesso ao download é preciso clicar na opção \textbf{Rstudio Desktop}.

\begin{figure}[htpb]
	\centering
	\includegraphics[width=\linewidth]{../figs/BP_Curso_TecComp_00_2019_f01-06}
	\caption{Aba de download do Rstudio}
	\label{fig:f01-06}
\end{figure}

\textbf{CONTINUAR DAQUI}
