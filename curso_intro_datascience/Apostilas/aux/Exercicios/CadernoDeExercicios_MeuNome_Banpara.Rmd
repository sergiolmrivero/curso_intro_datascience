...
a) Agora crie um lista através da função `list()` incluindo os três vetores criados anteriormente, chame-a de "lista"
...
a) Você vai precisar utilizar as bibliotecas "jsonlite", "dplyr", "lubridate" e "tidyr"", procure na internet e diga para que estas 3 bibliotecas são utilizadas no R.
...
### Utilizando o dplyr, tidy e lubridate
