...
\chapter{Aula 6 - Apresentando Resultados}
	...
	A figura abaixo mostra as principais camadas:


	
	A figura de \cite{Wilkinson2012} mostra cada camada do processo de construção de gráficos utilizando o ggplot2 
