...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{../figs/BP_Curso_TecComp_00_2019_f06-17}
	\caption{}
	\label{fig:bpcursoteccomp002019f06-17}
\end{figure}


\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{../figs/BP_Curso_TecComp_00_2019_f06-18}
	\caption{}
	\label{fig:bpcursoteccomp002019f06-18}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{../figs/BP_Curso_TecComp_00_2019_f06-11}
	\caption{Tipos de entradas}
	\label{fig:bpcursoteccomp002019f06-11}
\end{figure}
...
\begin{figure}
	...
	\caption{Tipos de Entradas (cont.)}
