...
\chapter{Aula 4 - Apresentando Resultados}
	...
	\subsection{O que é o Rmarkdown?}
...
@
	...
	\subsection{Como o Rmd funciona?}
	...
	\subsection{A estrutura de um arquivo .Rmd}
...
\subsection{Sintaxe de Markdown}
...
\end{figure}
	...
	\subsection{Exemplos de uso do .Rmd}
	
	
	\subsection{Algumas referências}
